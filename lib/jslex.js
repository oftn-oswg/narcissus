    ...
    Tokenizer.prototype = {
        ...
        get: function (scanOperand) {
            ...
            if (this.isIdentifierStart(ch)) {
                ...
                throw this.newSyntaxError("Illegal character "+ch+" on line "+this.lineno+" near "+input.substr(this.cursor-5, 10));
            }
        ...
        isIdentifierStart: function(ch) {
            ...
            var tkey = i/32|0;
            var shif = 1 << i%32;
            return !!(unicode.IdentifierStartLookup[tkey] & shif);
        },
        ...
        isIdentifierPart: function(ch) {
            ...
            var shif = 1 << i%32;
            return !!(unicode.IdentifierStartLookup[tkey] & shif ||
                unicode.IdentifierPartLookup[tkey] & shif);
        },
